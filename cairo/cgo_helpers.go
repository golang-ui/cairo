...
func readFunc69800AA2(cclosure unsafe.Pointer, cdata *C.uchar, clength C.uint) C.cairo_status_t {
	if readFunc69800AA2Func != nil {
		...
		var data69800aa2 []byte
		hxfc4425b := (*sliceHeader)(unsafe.Pointer(&data69800aa2))
		hxfc4425b.Data = uintptr(unsafe.Pointer(cdata))
...
// packSFontExtents reads sliced Go data structure out from plain C format.
func packSFontExtents(v []FontExtents, ptr0 *C.cairo_font_extents_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfFontExtentsValue]C.cairo_font_extents_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewFontExtentsRef(unsafe.Pointer(&ptr1))
	}
}
...
func userScaledFontInitFunc87C5D9CB(cscaledFont *C.cairo_scaled_font_t, ccr *C.cairo_t, cextents *C.cairo_font_extents_t) C.cairo_status_t {
	if userScaledFontInitFunc87C5D9CBFunc != nil {
		var scaledFont87c5d9cb []ScaledFont
		hxf95e7c8 := (*sliceHeader)(unsafe.Pointer(&scaledFont87c5d9cb))
		hxf95e7c8.Data = uintptr(unsafe.Pointer(cscaledFont))
		hxf95e7c8.Cap = 0x7fffffff
		// hxf95e7c8.Len = ?

		var cr87c5d9cb []Cairo
		hxff2234b := (*sliceHeader)(unsafe.Pointer(&cr87c5d9cb))
		hxff2234b.Data = uintptr(unsafe.Pointer(ccr))
		hxff2234b.Cap = 0x7fffffff
		// hxff2234b.Len = ?

		var extents87c5d9cb []FontExtents
		packSFontExtents(extents87c5d9cb, cextents)
...
// packSTextExtents reads sliced Go data structure out from plain C format.
func packSTextExtents(v []TextExtents, ptr0 *C.cairo_text_extents_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfTextExtentsValue]C.cairo_text_extents_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewTextExtentsRef(unsafe.Pointer(&ptr1))
	}
}
...
func userScaledFontRenderGlyphFunc32C7BE76(cscaledFont *C.cairo_scaled_font_t, cglyph C.ulong, ccr *C.cairo_t, cextents *C.cairo_text_extents_t) C.cairo_status_t {
	if userScaledFontRenderGlyphFunc32C7BE76Func != nil {
		var scaledFont32c7be76 []ScaledFont
		hxff73280 := (*sliceHeader)(unsafe.Pointer(&scaledFont32c7be76))
		hxff73280.Data = uintptr(unsafe.Pointer(cscaledFont))
		hxff73280.Cap = 0x7fffffff
		// hxff73280.Len = ?

		glyph32c7be76 := (uint)(cglyph)
		var cr32c7be76 []Cairo
		hxfa9955c := (*sliceHeader)(unsafe.Pointer(&cr32c7be76))
		hxfa9955c.Data = uintptr(unsafe.Pointer(ccr))
		hxfa9955c.Cap = 0x7fffffff
		// hxfa9955c.Len = ?

		var extents32c7be76 []TextExtents
		packSTextExtents(extents32c7be76, cextents)
...
// packSSGlyph reads sliced Go data structure out from plain C format.
func packSSGlyph(v [][]Glyph, ptr0 **C.cairo_glyph_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.cairo_glyph_t)(unsafe.Pointer(ptr0)))[i0]
		for i1 := range v[i0] {
			ptr2 := (*(*[m / sizeOfGlyphValue]C.cairo_glyph_t)(unsafe.Pointer(ptr1)))[i1]
			v[i0][i1] = *NewGlyphRef(unsafe.Pointer(&ptr2))
		}
	}
}
...
func userScaledFontTextToGlyphsFunc5FC4FFFD(cscaledFont *C.cairo_scaled_font_t, cutf8 *C.char, cutf8Len C.int, cglyphs **C.cairo_glyph_t, cnumGlyphs *C.int, cclusters **C.cairo_text_cluster_t, cnumClusters *C.int, cclusterFlags *C.cairo_text_cluster_flags_t) C.cairo_status_t {
	if userScaledFontTextToGlyphsFunc5FC4FFFDFunc != nil {
		var scaledFont5fc4fffd []ScaledFont
		hxfa3f05c := (*sliceHeader)(unsafe.Pointer(&scaledFont5fc4fffd))
		hxfa3f05c.Data = uintptr(unsafe.Pointer(cscaledFont))
		...
		packSSGlyph(glyphs5fc4fffd, cglyphs)
		var numGlyphs5fc4fffd []int32
		hxf0d18b7 := (*sliceHeader)(unsafe.Pointer(&numGlyphs5fc4fffd))
		hxf0d18b7.Data = uintptr(unsafe.Pointer(cnumGlyphs))
		hxf0d18b7.Cap = 0x7fffffff
		// hxf0d18b7.Len = ?

		var clusters5fc4fffd [][]TextCluster
		packSSTextCluster(clusters5fc4fffd, cclusters)
		var numClusters5fc4fffd []int32
		hxf2fab0d := (*sliceHeader)(unsafe.Pointer(&numClusters5fc4fffd))
		hxf2fab0d.Data = uintptr(unsafe.Pointer(cnumClusters))
		hxf2fab0d.Cap = 0x7fffffff
		// hxf2fab0d.Len = ?

		var clusterFlags5fc4fffd []TextClusterFlags
		hxf69fe70 := (*sliceHeader)(unsafe.Pointer(&clusterFlags5fc4fffd))
		hxf69fe70.Data = uintptr(unsafe.Pointer(cclusterFlags))
...
func userScaledFontUnicodeToGlyphFuncD4A3AAE6(cscaledFont *C.cairo_scaled_font_t, cunicode C.ulong, cglyphIndex *C.ulong) C.cairo_status_t {
	if userScaledFontUnicodeToGlyphFuncD4A3AAE6Func != nil {
		var scaledFontd4a3aae6 []ScaledFont
		hxf65bf54 := (*sliceHeader)(unsafe.Pointer(&scaledFontd4a3aae6))
		hxf65bf54.Data = uintptr(unsafe.Pointer(cscaledFont))
		hxf65bf54.Cap = 0x7fffffff
		// hxf65bf54.Len = ?

		unicoded4a3aae6 := (uint)(cunicode)
		var glyphIndexd4a3aae6 []uint
		hxf3b8dbd := (*sliceHeader)(unsafe.Pointer(&glyphIndexd4a3aae6))
		hxf3b8dbd.Data = uintptr(unsafe.Pointer(cglyphIndex))
...
func (x *Path) Deref() {
	...
	hxf7a6dff := (*sliceHeader)(unsafe.Pointer(&x.Data))
	hxf7a6dff.Data = uintptr(unsafe.Pointer(x.reffd10d41e.data))
...
func surfaceObserverCallback9F372381(cobserver *C.cairo_surface_t, ctarget *C.cairo_surface_t, cdata unsafe.Pointer) {
	if surfaceObserverCallback9F372381Func != nil {
		var observer9f372381 []Surface
		hxfe48d67 := (*sliceHeader)(unsafe.Pointer(&observer9f372381))
		hxfe48d67.Data = uintptr(unsafe.Pointer(cobserver))
		hxfe48d67.Cap = 0x7fffffff
		// hxfe48d67.Len = ?

		var target9f372381 []Surface
		hxf4171bf := (*sliceHeader)(unsafe.Pointer(&target9f372381))
		hxf4171bf.Data = uintptr(unsafe.Pointer(ctarget))
...
// packSRectangleInt reads sliced Go data structure out from plain C format.
func packSRectangleInt(v []RectangleInt, ptr0 *C.cairo_rectangle_int_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfRectangleIntValue]C.cairo_rectangle_int_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewRectangleIntRef(unsafe.Pointer(&ptr1))
	}
}
...
func rasterSourceAcquireFuncE7404447(cpattern *C.cairo_pattern_t, ccallbackData unsafe.Pointer, ctarget *C.cairo_surface_t, cextents *C.cairo_rectangle_int_t) *C.cairo_surface_t {
	if rasterSourceAcquireFuncE7404447Func != nil {
		var patterne7404447 []Pattern
		hxf058b18 := (*sliceHeader)(unsafe.Pointer(&patterne7404447))
		hxf058b18.Data = uintptr(unsafe.Pointer(cpattern))
		hxf058b18.Cap = 0x7fffffff
		// hxf058b18.Len = ?

		callbackDatae7404447 := (unsafe.Pointer)(unsafe.Pointer(ccallbackData))
		var targete7404447 []Surface
		hxff6bc57 := (*sliceHeader)(unsafe.Pointer(&targete7404447))
		hxff6bc57.Data = uintptr(unsafe.Pointer(ctarget))
		hxff6bc57.Cap = 0x7fffffff
		// hxff6bc57.Len = ?

		var extentse7404447 []RectangleInt
		packSRectangleInt(extentse7404447, cextents)
...
func rasterSourceReleaseFunc659BFE43(cpattern *C.cairo_pattern_t, ccallbackData unsafe.Pointer, csurface *C.cairo_surface_t) {
	if rasterSourceReleaseFunc659BFE43Func != nil {
		var pattern659bfe43 []Pattern
		hxf5fa529 := (*sliceHeader)(unsafe.Pointer(&pattern659bfe43))
		hxf5fa529.Data = uintptr(unsafe.Pointer(cpattern))
		hxf5fa529.Cap = 0x7fffffff
		// hxf5fa529.Len = ?

		callbackData659bfe43 := (unsafe.Pointer)(unsafe.Pointer(ccallbackData))
		var surface659bfe43 []Surface
		hxf21690b := (*sliceHeader)(unsafe.Pointer(&surface659bfe43))
		hxf21690b.Data = uintptr(unsafe.Pointer(csurface))
...
func rasterSourceSnapshotFunc518A3707(cpattern *C.cairo_pattern_t, ccallbackData unsafe.Pointer) C.cairo_status_t {
	if rasterSourceSnapshotFunc518A3707Func != nil {
		var pattern518a3707 []Pattern
		hxf1231c9 := (*sliceHeader)(unsafe.Pointer(&pattern518a3707))
		hxf1231c9.Data = uintptr(unsafe.Pointer(cpattern))
...
func rasterSourceCopyFunc84D80D8B(cpattern *C.cairo_pattern_t, ccallbackData unsafe.Pointer, cother *C.cairo_pattern_t) C.cairo_status_t {
	if rasterSourceCopyFunc84D80D8BFunc != nil {
		var pattern84d80d8b []Pattern
		hxf04b15b := (*sliceHeader)(unsafe.Pointer(&pattern84d80d8b))
		hxf04b15b.Data = uintptr(unsafe.Pointer(cpattern))
		hxf04b15b.Cap = 0x7fffffff
		// hxf04b15b.Len = ?

		callbackData84d80d8b := (unsafe.Pointer)(unsafe.Pointer(ccallbackData))
		var other84d80d8b []Pattern
		hxf2f888b := (*sliceHeader)(unsafe.Pointer(&other84d80d8b))
		hxf2f888b.Data = uintptr(unsafe.Pointer(cother))
...
func rasterSourceFinishFuncECE7E85B(cpattern *C.cairo_pattern_t, ccallbackData unsafe.Pointer) {
	if rasterSourceFinishFuncECE7E85BFunc != nil {
		var patternece7e85b []Pattern
		hxf5d1de2 := (*sliceHeader)(unsafe.Pointer(&patternece7e85b))
		hxf5d1de2.Data = uintptr(unsafe.Pointer(cpattern))
...
// unpackArgSUserDataKey transforms a sliced Go data structure into plain C format.
func unpackArgSUserDataKey(x []UserDataKey) (unpacked *C.cairo_user_data_key_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_user_data_key_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocUserDataKeyMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_user_data_key_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_user_data_key_t)(unsafe.Pointer(h.Data))
	return
}

// packSUserDataKey reads sliced Go data structure out from plain C format.
func packSUserDataKey(v []UserDataKey, ptr0 *C.cairo_user_data_key_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfUserDataKeyValue]C.cairo_user_data_key_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewUserDataKeyRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgSMatrix transforms a sliced Go data structure into plain C format.
func unpackArgSMatrix(x []Matrix) (unpacked *C.cairo_matrix_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_matrix_t) {
		go allocs.Free()
	})
	...
	v0 := *(*[]C.cairo_matrix_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_matrix_t)(unsafe.Pointer(h.Data))
	return
}

// packSMatrix reads sliced Go data structure out from plain C format.
func packSMatrix(v []Matrix, ptr0 *C.cairo_matrix_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfMatrixValue]C.cairo_matrix_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewMatrixRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgSRectangleList transforms a sliced Go data structure into plain C format.
func unpackArgSRectangleList(x []RectangleList) (unpacked *C.cairo_rectangle_list_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_rectangle_list_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocRectangleListMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_rectangle_list_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_rectangle_list_t)(unsafe.Pointer(h.Data))
	return
}

// packSRectangleList reads sliced Go data structure out from plain C format.
func packSRectangleList(v []RectangleList, ptr0 *C.cairo_rectangle_list_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfRectangleListValue]C.cairo_rectangle_list_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewRectangleListRef(unsafe.Pointer(&ptr1))
	}
}
...
func unpackArgSGlyph(x []Glyph) (unpacked *C.cairo_glyph_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
func packSGlyph(v []Glyph, ptr0 *C.cairo_glyph_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfGlyphValue]C.cairo_glyph_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewGlyphRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgSTextCluster transforms a sliced Go data structure into plain C format.
func unpackArgSTextCluster(x []TextCluster) (unpacked *C.cairo_text_cluster_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	len0 := len(x)
	mem0 := allocTextClusterMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
...
// packSTextCluster reads sliced Go data structure out from plain C format.
func packSTextCluster(v []TextCluster, ptr0 *C.cairo_text_cluster_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfTextClusterValue]C.cairo_text_cluster_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewTextClusterRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgSTextExtents transforms a sliced Go data structure into plain C format.
func unpackArgSTextExtents(x []TextExtents) (unpacked *C.cairo_text_extents_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_text_extents_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocTextExtentsMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_text_extents_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_text_extents_t)(unsafe.Pointer(h.Data))
	return
}

// unpackArgSFontExtents transforms a sliced Go data structure into plain C format.
func unpackArgSFontExtents(x []FontExtents) (unpacked *C.cairo_font_extents_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_font_extents_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocFontExtentsMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_font_extents_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_font_extents_t)(unsafe.Pointer(h.Data))
	return
}
...
// unpackArgSSGlyph transforms a sliced Go data structure into plain C format.
func unpackArgSSGlyph(x [][]Glyph) (unpacked **C.cairo_glyph_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	for i0 := range x {
		...
		v1 := *(*[]C.cairo_glyph_t)(unsafe.Pointer(h1))
		for i1 := range x[i0] {
		...
		v0[i0] = (*C.cairo_glyph_t)(unsafe.Pointer(h.Data))
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (**C.cairo_glyph_t)(unsafe.Pointer(h.Data))
	return
...
// unpackArgSPath transforms a sliced Go data structure into plain C format.
func unpackArgSPath(x []Path) (unpacked *C.cairo_path_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_path_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocPathMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_path_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_path_t)(unsafe.Pointer(h.Data))
	return
}

// packSPath reads sliced Go data structure out from plain C format.
func packSPath(v []Path, ptr0 *C.cairo_path_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPathValue]C.cairo_path_t)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = *NewPathRef(unsafe.Pointer(&ptr1))
	}
}

// unpackArgSRectangleInt transforms a sliced Go data structure into plain C format.
func unpackArgSRectangleInt(x []RectangleInt) (unpacked *C.cairo_rectangle_int_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(**C.cairo_rectangle_int_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocRectangleIntMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]C.cairo_rectangle_int_t)(unsafe.Pointer(h0))
	for i0 := range x {
		allocs0 := new(cgoAllocMap)
		v0[i0], allocs0 = x[i0].PassValue()
		allocs.Borrow(allocs0)
	...
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (*C.cairo_rectangle_int_t)(unsafe.Pointer(h.Data))
	return
}
...
func unpackArgSUString(x []string) (unpacked **C.uchar, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	...
	for i0 := range x {
		v0[i0], _ = unpackPUcharString(x[i0])
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
...
func packSUString(v []string, ptr0 **C.uchar) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.uchar)(unsafe.Pointer(ptr0)))[i0]
		v[i0] = packPUcharString(ptr1)
	}
}

// unpackArgSRectangle transforms a sliced Go data structure into plain C format.
func unpackArgSRectangle(x []Rectangle) (unpacked *C.cairo_rectangle_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
...
// allocPSurfaceMemory allocates memory for type *C.cairo_surface_t in C.
// The caller is responsible for freeing the this memory via C.free.
func allocPSurfaceMemory(n int) unsafe.Pointer {
	mem, err := C.calloc(C.size_t(n), (C.size_t)(sizeOfPSurfaceValue))
	if err != nil {
		panic("memory alloc error: " + err.Error())
	}
	return mem
...
const sizeOfPSurfaceValue = unsafe.Sizeof([1]*C.cairo_surface_t{})

// unpackArgSSSurface transforms a sliced Go data structure into plain C format.
func unpackArgSSSurface(x [][]Surface) (unpacked **C.cairo_surface_t, allocs *cgoAllocMap) {
	if x == nil {
		return nil, nil
	}
	allocs = new(cgoAllocMap)
	defer runtime.SetFinalizer(&unpacked, func(***C.cairo_surface_t) {
		go allocs.Free()
	})

	len0 := len(x)
	mem0 := allocPSurfaceMemory(len0)
	allocs.Add(mem0)
	h0 := &sliceHeader{
		Data: uintptr(mem0),
		Cap:  len0,
	...
	v0 := *(*[]*C.cairo_surface_t)(unsafe.Pointer(h0))
	for i0 := range x {
		h := (*sliceHeader)(unsafe.Pointer(&x[i0]))
		v0[i0] = (*C.cairo_surface_t)(unsafe.Pointer(h.Data))
	}
	h := (*sliceHeader)(unsafe.Pointer(&v0))
	unpacked = (**C.cairo_surface_t)(unsafe.Pointer(h.Data))
	return
}

// packSSSurface reads sliced Go data structure out from plain C format.
func packSSSurface(v [][]Surface, ptr0 **C.cairo_surface_t) {
	const m = 0x7fffffff
	for i0 := range v {
		ptr1 := (*(*[m / sizeOfPtr]*C.cairo_surface_t)(unsafe.Pointer(ptr0)))[i0]
